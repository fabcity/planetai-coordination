...
> Bioregional pilot of the PLANETAI program. Anchored in the world's first declared "Fab Island" under the Fab City Global Initiative, with a 2054 self-sufficiency pledge already in place.

This page is partner-validated. Each section below has its own status, action links, and validators list. If anything is wrong, missing, or out of date — use the **Validate**, **Suggest changes** or **Add a comment** links beside the section.
...
The pilot's most distinctive methodological commitment is the **Tri Hita Karana ↔ four-pillar mapping**, scoped explicitly as a Bali co-design experiment (per the [Path B decision](../decisions/2026-05-01_tri-hita-karana-path-b.html)). Publication of this mapping is conditional on customary-authority sign-off — banjar adat, desa adat, or a PHDI scholar — to be named jointly by the Bali partner team.

## What's running

**Fab Lab Bali (= MDG, legally).** Active and equipped — 3D printers, laser cutters, CNC, electronics. Meaningful Design Group is the legal entity behind Fab Lab Bali; they are one operational unit. MDG carries the contractual identity, Fab Lab Bali the public-facing brand. Executive arm of the Green Hydrogen Village programme. Offering Fab Academy scholarships in 2025 via the Net Zero Bali Coalition. ([fablabbali.com](https://www.fablabbali.com/))

**CAST Foundation (Yayasan Culture Art Science Technology).** Coordinator and administrator of the Hydrogen Village project; one of five member organisations of the Bali Net Zero Emission Coalition. Hosts the Matangi Bali Initiative (women + youth climate-entrepreneurship) with NEN Indonesia. Partnership with Indonesia Fuel Cell and Hydrogen Energy. ([castfoundation.id](https://castfoundation.id/))

**IT Del Bali office (Ben Koo) + Sumatra AI infrastructure.** Local technical presence in Bali. The Sumatra campus runs LPPM and an AI Center of Excellence under Rosni Lumbantoruan, and is one of Indonesia's most substantial domestic AI compute deployments. Ben Koo is the lead author of the **Personal Knowledge Container (PKC)** framework (Koo, Aliana & Corley 2023, IEEE) — the sovereignty-by-architecture lineage cited as a canonical reference in the PLANETAI core ideas. Active in Lake Toba environmental monitoring research from the Sumatra side.

**Bali Net Zero Emission Coalition (established 2024).** Secretariat: WRI Indonesia. Existing PMO and measurement framework. Hiring a Bali-based Net Zero Emission Policy Specialist for 2026. Aligned with Bali's "Nangun Sat Kerthi Loka Bali" sustainable development vision — itself a Tri Hita Karana lineage in policy form. ([Bali Coalition](https://koalisibaliemisinolbersih.org/en/) · [WRI Bali NZE Initiative](https://wri-indonesia.org/en/initiatives/bali-net-zero-emission-2045-initiative))

## Data access

**Bali Satu Data** — the Bali Province open-data portal under Governor Regulation (Pergub) 53/2021, published by Tim SPBE Diskominfos. The portal carries 4,700+ datasets organised through six Tri Hita Karana cosmological categories: **Jana** (society / people), **Atma** (wellbeing / spirit), **Jagat** (territory / world), **Wana** (forest), **Danu** (water), **Segara** (sea / coast). Release cadence is broadly annual — meaning sub-annual measurement requires sensor-campaign supplementation. ([balisatudata.baliprov.go.id](https://balisatudata.baliprov.go.id/))
...
**Indonesia NSDI** (national geospatial data infrastructure) via BIG, plus decade-scale ERA5 climate analyses for Lake Toba ([Nature Sci. Reports 2023](https://www.nature.com/articles/s41598-023-29592-y)) and World Bank water-quality remote-sensing work for the same region — directly relevant to IT Del's compute-backbone story.

**Tropical-humidity sensor calibration.** Existing literature provides ML calibration models with humidity + particle-count predictors — see for example the Bandung PurpleAir study (2022–2023, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S2307410824001226)). PLANETAI Bali applies the existing methodology rather than redoing the underlying research.
...
These are the questions where partner input is most welcome — naming, coverage checks, capacity confirmations.
